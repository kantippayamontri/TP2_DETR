...
do
    ...
    echo "========================================"
    echo "Starting split_id: $split_id with seed: $((3552 + split_id))"
    echo "Start time: $start_time_formatted"
    echo "========================================"
    
    # Run the command for each split_id
    # Set seed based on split_id for reproducibility (e.g., 3552 + split_id)
    seed=$((3552 + split_id))
    ...
    echo "========================================"
    echo "Ending split_id: $split_id"
    echo "End time: $end_time_formatted"
    echo "Duration: ${hours}h ${minutes}m ${seconds}s (Total: ${duration}s)"
    echo "========================================"
done
