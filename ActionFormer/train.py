...
def train(model: torch.nn.Module, 
    ...
    for batch_idx, (samples, targets) in enumerate(data_loader):
        ...
        outputs = model(samples, classes, description_dict, targets, epoch, seen_classes_names=seen_classes_names, unseen_classes_names=unseen_classes_names, batch_idx=batch_idx)
 
        loss_dict = criterion(outputs, targets, epoch, batch_idx=batch_idx, semantic_guided_unseen_weights=semantic_guided_unseen_weights)
